import { stateAbbreviationToFips, fipsToAbbreviation } from "../../../src/Components/ChoroplethMap/utils/state-abbreviation-fips-processing";
...
describe("state abbreviation to fips and fips to state abbreviation unit test", () => {
    it("stateAbbreviationToFips should return the correct Fips code for Washington State", () => {
        expect(stateAbbreviationToFips["WA"]).toEqual("53");
    })
    it("fipsToAbbreviation should return the WA for the fips code 53", () => {
